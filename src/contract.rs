...
pub fn instantiate(
    deps: DepsMut,
    _env: Env,
    info: MessageInfo, // Message metadata, contains the sender of the message (Addr) and the funds sent with it a Vec<Coin>.
    msg: InstantiateMsg, // The InstantiateMsg you define in src/msg.rs.
...
mod tests {
    ...
    use crate::msg::{AllPollsResponse, ExecuteMsg, InstantiateMsg, QueryMsg, VoteResponse};
    ...
    fn test_query_all_polls() {
        ...
        let bin = crate::contract::query(deps.as_ref(), env, msg).unwrap();
